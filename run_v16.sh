...
sudo sysctl -p
sed -i 's/10001/'$PORT'/g' $DESTINATION/docker-compose_v16.yml
sed -i 's/20001/'$CHAT'/g' $DESTINATION/docker-compose_v16.yml
# correr Odoo
docker-compose -f $DESTINATION/docker-compose_v16.yml up -d
